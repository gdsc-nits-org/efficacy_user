...
class VerificatioCodePage extends StatefulWidget {
  static const String routeName = '/VerificationCodePage';
  const VerificatioCodePage({super.key});

  @override
  State<VerificatioCodePage> createState() => _VerificatioCodePageState();
}

class _VerificatioCodePageState extends State<VerificatioCodePage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextField(
                              ...
                              validator: (value)=>Validator.nullCheck(value, "Verification Code"),
                              borderRadius: 50,
                              height: 79,
